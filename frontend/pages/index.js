...
export default function CampusConnect() {
  ...
  const demoUsers = [
    ...
    },
    {
      ...
      bio: 'Biology student researching environmental science and sustainability',
      major: 'Biology',
      year: 'Senior',
    ...
    },
    {
      ...
      bio: 'Business major focusing on entrepreneurship and startup culture',
      major: 'Business',
      year: 'Sophomore',
      interests: ['Entrepreneurship', 'Football', 'Networking', 'Startups'],
      avatar: '👨‍💼',
      online: false
    },
    {
      ...
      bio: 'Art student specializing in digital media and graphic design',
      major: 'Digital Arts',
      year: 'Junior',
      interests: ['Digital Art', 'Design', 'Museums', 'Coffee'],
      avatar: '👩‍🎨',
      online: true
    },
    {
      ...
      bio: 'Psychology major interested in cognitive behavior and mental health',
      major: 'Psychology',
      year: 'Freshman',
      interests: ['Psychology', 'Yoga', 'Reading', 'Meditation'],
      avatar: '👨‍⚕️',
      online: false
    }
  ];
  ...
  const demoMessages = {
    1: [
      { id: 1, senderId: 1, text: "Hey! I saw you're in CS too. Want to study together?", timestamp: new Date(Date.now() - 3600000) },
      { id: 2, senderId: 0, text: "That would be great! I'm struggling with the algorithms assignment", timestamp: new Date(Date.now() - 3500000) },
      { id: 3, senderId: 1, text: "Same here! Let's meet at the library tomorrow?", timestamp: new Date(Date.now() - 3400000) }
    ],
    2: [
      { id: 1, senderId: 2, text: "Hi! I noticed we're both interested in sustainability", timestamp: new Date(Date.now() - 7200000) },
      { id: 2, senderId: 0, text: "Yes! Are you part of any environmental clubs?", timestamp: new Date(Date.now() - 7100000) }
    ],
    4: [
      { id: 1, senderId: 4, text: "Love your profile! The design work is impressive", timestamp: new Date(Date.now() - 1800000) },
      { id: 2, senderId: 0, text: "Thanks! I saw your portfolio too - amazing stuff!", timestamp: new Date(Date.now() - 1700000) },
      { id: 3, senderId: 4, text: "We should collaborate on a project sometime! 🎨", timestamp: new Date(Date.now() - 1600000) }
    ]
  };
  ...
  useEffect(() => {
    if (backendStatus === 'offline') {
      ...
      setFriends(demoUsers.slice(0, 3));
      setFriendRequests([
        {
          id: 1,
          from: demoUsers[4],
    ...
    try {
      ...
      if (backendStatus === 'offline') {
        const demoUser = {
          ...
          bio: 'Welcome to CampusConnect! Start connecting with other students.',
          major: 'Undeclared',
          year: 'Freshman',
        ...
        setUser(demoUser);
        setView('dashboard');
        addNotification('success', `Welcome to CampusConnect, ${demoUser.firstName}! (Demo Mode)`);
      } else {
  ...
  const rejectFriendRequest = async (request) => {
    if (backendStatus === 'online') {
      try {
        ...
        if (res.ok) {
          addNotification('info', `Friend request from ${request.from.firstName} rejected`);
          setFriendRequests(prev => prev.filter(r => r.id !== request.id));
        }
      } catch (error) {
        addNotification('error', 'Error rejecting friend request');
      }
    } else {
      // Demo mode
      addNotification('info', `Friend request from ${request.from.firstName} rejected (Demo)`);
      setFriendRequests(prev => prev.filter(r => r.id !== request.id));
    }
  };
      ...
      <div style={styles.landing}>
        ...
        <main style={styles.hero}>
          <div style={styles.heroContent}>
            ...
            <div style={styles.statusBanner}>
              <div style={styles.statusContent}>
                ...
                {backendStatus === 'online' ? ' Live & Connected' : ' Demo Mode - Working Offline'}
              </div>
            </div>
          ...
          <div style={styles.featuresShowcase}>
            {[
              ...
              },
              {
                icon: '💬',
                title: 'Real Chat',
                description: 'Message friends instantly with our real-time chat system'
              },
              {
                icon: '🎯',
          ...
          <div style={styles.testimonials}>
            <h2 style={styles.testimonialsTitle}>Loved by Students Worldwide</h2>
            <div style={styles.testimonialsGrid}>
              {[
                {
                  name: "Sarah Chen",
                  role: "Computer Science, Stanford",
                  text: "Made my best study group through CampusConnect!",
                  avatar: "👩‍💻"
                },
                {
                  name: "Mike Rodriguez",
                  role: "Business, NYU",
                  text: "Found amazing project partners and lifelong friends!",
                  avatar: "👨‍💼"
                },
                {
                  name: "Emily Park",
                  role: "Biology, UCLA",
                  text: "The perfect platform to network before even arriving on campus!",
                  avatar: "👩‍🔬"
                }
        ...
        <aside style={styles.sidebar}>
          <nav style={styles.sidebarNav}>
            {[
              ...
              { id: 'chat', icon: '💬', label: 'Messages', count: messages.length },
              ...
              <button
                ...
                onClick={() => setActiveChat(item.id === 'chat' ? null : item.id)}
              >
          ...
          <div style={styles.onlineSection}>
            <h4 style={styles.sectionTitle}>Online Now</h4>
            <div style={styles.onlineList}>
              {friends.filter(f => f.online).slice(0, 5).map(friend => (
                <div
                  key={friend.id}
                ...
                >
                  ...
                  <span style={styles.onlineName}>{friend.firstName}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {activeChat === 'discover' && (
            <div style={styles.page}>
              <div style={styles.pageHeader}>
                ...
                <p style={styles.pageSubtitle}>Connect with students who share your interests</p>
              </div>
          ...
          {activeChat === 'friends' && (
            <div style={styles.page}>
              <div style={styles.pageHeader}>
                ...
                <p style={styles.pageSubtitle}>{friends.length} connections</p>
              </div>
                ...
                {filteredFriends.map(friend => (
                  ...
                  >
                    <div style={styles.friendAvatar}>
                      {friend.avatar}
                      {friend.online && <div style={styles.onlineIndicator}></div>}
                    </div>
          ...
          {activeChat === 'requests' && (
            <div style={styles.page}>
              <div style={styles.pageHeader}>
                ...
                <p style={styles.pageSubtitle}>{friendRequests.length} pending requests</p>
              </div>
            ...
            <div style={styles.chatContainer}>
              <div style={styles.chatHeader}>
                <div style={styles.chatUser}>
                  <div style={styles.chatAvatar}>
                    {activeChat.avatar}
                    {activeChat.online && <div style={styles.onlineIndicator}></div>}
                  </div>
                  <div>
                    <h3 style={styles.chatUserName}>{activeChat.firstName} {activeChat.lastName}</h3>
                    <p style={styles.chatUserStatus}>
                      {activeChat.online ? 'Online' : 'Offline'} • {activeChat.major}
                    </p>
                  </div>
                </div>
                <div style={styles.chatActions}>
                  <button style={styles.chatAction}>📞</button>
                  <button style={styles.chatAction}>🎥</button>
                  <button style={styles.chatAction}>⚙️</button>
                </div>
              </div>
              ...
              <div style={styles.messagesContainer}>
                {messages.length === 0 ? (
                  <div style={styles.emptyChat}>
                    ...
                    <button 
                      onClick={() => setNewMessage("Hey! I came across your profile and would love to connect!")}
              ...
              <form onSubmit={sendMessage} style={styles.messageForm}>
                ...
                <div style={styles.quickReplies}>
                  {["Hey!", "What's up?", "Want to study together?", "Nice to meet you!"].map((reply, index) => (
                    <button
                      key={index}
                      type="button"
            ...
            <div style={styles.welcome}>
              <div style={styles.welcomeContent}>
                ...
                <p style={styles.welcomeSubtitle}>
                  Start connecting with other students. Discover new friends, join conversations, and build your campus network.
                </p>
        ...
        <div style={styles.modalOverlay}>
          <div style={styles.modal}>
            <div style={styles.modalHeader}>
              <h3>Edit Profile</h3>
              <button onClick={() => setProfileEdit(false)} style={styles.closeButton}>✕</button>
            </div>
            <div style={styles.modalContent}>
              ...
              <div style={styles.formGroup}>
                <label>Major</label>
                <input type="text" placeholder="Your major" style={styles.input} />
              </div>
              <div style={styles.formGroup}>
                <label>Year</label>
              ...
              <div style={styles.formGroup}>
                ...
                <input type="text" placeholder="Add interests separated by commas" style={styles.input} />
              </div>
...
// COMPLETE STYLES WITH ANIMATIONS
const styles = {
  // Global Styles
  landing: {
    minHeight: '100vh',
